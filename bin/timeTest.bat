::@echo off
echo %time%
java BurrowsWheeler - < ..\assignment5_burrows\burrows-testing\mytest\bitmap3.bmp | java MoveToFront - | java edu.princeton.cs.algs4.Huffman - > ..\assignment5_burrows\burrows-testing\mytest\bitmap3_ManberMyers.bmp.bwt.mtf.huf
